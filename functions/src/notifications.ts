...
function eventCopy(eventType: string, storeName: string, itemName: string) {
  switch (eventType) {
    ...
    case 'booking.created': return { customerTitle: 'Booking received', customerIntro: `Your booking for ${itemName} has been received by ${storeName}.`, adminTitle: 'New booking received', adminAction: 'Review the booking and contact the customer where needed.' }
    case 'student_registration.paid':
    case 'student_registration.created': return { customerTitle: 'Registration received', customerIntro: `Your registration for ${itemName} has been received. ${storeName} will contact you with the next steps.`, adminTitle: 'New student registration', adminAction: 'Review the registration and follow up with the student.' }
    ...
    case 'event_registration.created': return { customerTitle: 'Registration received', customerIntro: `Your registration for ${itemName} has been received by ${storeName}.`, adminTitle: 'New event registration', adminAction: 'Review the registration and confirm attendance where needed.' }
