...
export default function AuthPage() {
  ...
  function handleModeChange(nextMode: AuthMode) { setMode(nextMode); setStatus({ tone: 'idle', message: '' }); setConfirmPassword(''); setFullName(''); setBusinessName(''); setPhone(''); setCountry(''); setTown(''); setAddress('') }
  ...
  return (
    <main className="app" style={{ minHeight: '100dvh' }}>
      <div className="app__layout">
        ...
        <aside className="app__visual" aria-label="Sedifex business operating system"><div className="app__visual-media" role="presentation"><img src={AUTH_VISUAL_IMAGE_URL} alt="Business owner using Sedifex on a laptop" loading="lazy" /></div><div className="app__visual-overlay" /><div className="app__visual-caption"><span className="app__visual-pill">Free business operating system</span><h2>Sales, customers, bookings, registrations, payments, and growth tools in one place.</h2><p>Start with the free plan. Add paid power only when your business needs more capacity, automation, marketplace visibility, or integrations.</p></div></aside>
      </div>
